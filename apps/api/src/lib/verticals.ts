...
export const VERTICALS = [
  ...
  { type: "CAR", label: "Car", tagline: "Intercity per-seat car — book 1 or more seats", icon: "🚗", flavor: "ROUTE", primary: true },
  { type: "HIACE", label: "HiAce", tagline: "Intercity per-seat HiAce van — book 1 or more seats", icon: "🚐", flavor: "ROUTE", primary: true },
